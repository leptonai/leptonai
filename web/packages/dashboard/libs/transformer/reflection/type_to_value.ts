...
export function typeToValue(
  ...
  // TODO(yadong): typescript path alias not work here, skip noValueDeclaration check.
  // if (
  //   decl.valueDeclaration === undefined ||
...
function resolveTypeSymbols(
  ...
  const typeRefSymbol: ts.Symbol | undefined =
