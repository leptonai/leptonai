...
@click.option(
    ...
    help=(
        ...
        " variable. This is used when the deployment code uses Lepton SDK capabilities"
        " such as queue, KV, objectstore etc. Note that you should trust the code in the"
