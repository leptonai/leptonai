...
def update(
    ...
    if not skip_dryrun:
        ...
        if dryrun_response.metadata.replica_version != lepton_deployment.metadata.replica_version:
            response = input("This update will trigger a rolling restart. Are you sure you want to proceed? (yes/no): ").strip().lower()
