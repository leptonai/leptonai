...
def is_command_installed(command: str):
    try:
        ...
        output = output.decode('utf-8').strip()  # Convert bytes to string and remove leading/trailing whitespace
...
def run_terraform_apply(dir: str, name: str):
    ...
    if terraform_init.wait() != 0:
        ...
        console.print(f'Failed to initialize terraform')
        console.print("Stderr output:\n", stderr_output.decode())
        console.print("Stdout output:\n", stdout_output.decode())
        return False, ""
    console.print(f'Initialized the installer (Terraform)')
    ...
    console.print(f'Finished installation')
...
def run_terraform_destroy(dir: str, name: str):
    ...
    if terraform_destroy.returncode != 0:
        ...
        return False
    console.print(f'Removed the cluster')
