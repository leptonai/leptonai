...
func main() {
	...
	v1.GET("/deployments/:did/instances", handler.ReplicaHandler().List)
	v1.GET("/deployments/:did/instances/:rid/shell", handler.ReplicaHandler().Shell)
	v1.GET("/deployments/:did/instances/:rid/log", handler.ReplicaHandler().Log)

	v1.GET("/deployments/:did/instances/:rid/monitoring/memoryUtil", handler.MonitoringHandler().ReplicaMemoryUtil)
	v1.GET("/deployments/:did/instances/:rid/monitoring/memoryUsage", handler.MonitoringHandler().ReplicaMemoryUsage)
	v1.GET("/deployments/:did/instances/:rid/monitoring/memoryTotal", handler.MonitoringHandler().ReplicaMemoryTotal)
	v1.GET("/deployments/:did/instances/:rid/monitoring/CPUUtil", handler.MonitoringHandler().ReplicaCPUUtil)

	v1.GET("/deployments/:did/instances/:rid/monitoring/FastAPIQPS", handler.MonitoringHandler().ReplicaFastAPIQPS)
	v1.GET("/deployments/:did/instances/:rid/monitoring/FastAPILatency", handler.MonitoringHandler().ReplicaFastAPILatency)
	v1.GET("/deployments/:did/instances/:rid/monitoring/FastAPIByPathQPS", handler.MonitoringHandler().ReplicaFastAPIQPSByPath)
	v1.GET("/deployments/:did/instances/:rid/monitoring/FastAPIByPathLatency", handler.MonitoringHandler().ReplicaFastAPILatencyByPath)

	v1.GET("/deployments/:did/instances/:rid/monitoring/GPUMemoryUtil", handler.MonitoringHandler().ReplicaGPUMemoryUtil)
	v1.GET("/deployments/:did/instances/:rid/monitoring/GPUMemoryUsage", handler.MonitoringHandler().ReplicaGPUMemoryUsage)
	v1.GET("/deployments/:did/instances/:rid/monitoring/GPUMemoryTotal", handler.MonitoringHandler().ReplicaGPUMemoryTotal)
	v1.GET("/deployments/:did/instances/:rid/monitoring/GPUUtil", handler.MonitoringHandler().ReplicaGPUUtil)
