...
resource "aws_autoscaling_group_tag" "al2_x86_64_cpu_m6a16xlarge_autoscaler_kind" {
  # we may disable CPU AL2 node groups for CI testing
  count = var.al2_x86_64_cpu_max_size > 0 ? 1 : 0
...
resource "aws_autoscaling_group_tag" "al2_x86_64_cpu_m6a16xlarge_ephemeral_storage" {
  # we may disable CPU AL2 node groups for CI testing
  count = var.al2_x86_64_cpu_max_size > 0 ? 1 : 0
