...
resource "aws_autoscaling_group_tag" "ubuntu_x86_64_ac_g52xlarge_autoscaler_kind" {
  # we may disable GPU node groups for CI testing
  count = var.ubuntu_x86_64_ac_g52xlarge_max_size > 0 ? 1 : 0
...
# ref. https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/autoscaling_group_tag
resource "aws_autoscaling_group_tag" "ubuntu_x86_64_ac_g52xlarge_node_selector" {
  # we may disable GPU node groups for CI testing
  count = var.ubuntu_x86_64_ac_g52xlarge_max_size > 0 ? 1 : 0
...
resource "aws_autoscaling_group_tag" "ubuntu_x86_64_ac_g52xlarge_taint" {
  # we may disable GPU node groups for CI testing
  count = var.ubuntu_x86_64_ac_g52xlarge_max_size > 0 ? 1 : 0
...
resource "aws_autoscaling_group_tag" "ubuntu_x86_64_ac_g52xlarge_ephemeral_storage" {
  # we may disable GPU node groups for CI testing
  count = var.ubuntu_x86_64_ac_g52xlarge_max_size > 0 ? 1 : 0
